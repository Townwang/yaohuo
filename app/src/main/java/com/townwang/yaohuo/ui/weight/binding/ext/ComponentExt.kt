...
import com.townwang.yaohuo.ui.weight.binding.databind.*
...
inline fun <reified T : ViewDataBinding> ViewGroup.databind(@LayoutRes resId: Int) =
...
inline fun <reified T : ViewDataBinding> ViewGroup.databind(
    @LayoutRes resId: Int,
    noinline block: (T.() -> Unit)
) = ViewGroupDataBinding(
    T::class.java,
