...
class TownNiceImageView @JvmOverloads constructor(
    ...
    private var isCircle = true// 是否显示为圆形，如果为圆形则设置的corner无效 = false
    ...
    private var innerBorderWidth = 1// 内层边框宽度 = 0
    ...
    fun setBorderWidth(borderWidth: Int) {
        this.borderWidth = context.dp2px(borderWidth)
    ...
    fun setInnerBorderWidth(innerBorderWidth: Int) {
        this.innerBorderWidth = context.dp2px(innerBorderWidth)
        clearInnerBorderWidth()
        invalidate()
    }
    ...
    fun setCornerRadius(cornerRadius: Int) {
        this.cornerRadius = context.dp2px(cornerRadius)
        calculateRadiiAndRectF(false)
    }

    fun setCornerTopLeftRadius(cornerTopLeftRadius: Int) {
        this.cornerTopLeftRadius = context.dp2px(cornerTopLeftRadius)
        calculateRadiiAndRectF(true)
    }

    fun setCornerTopRightRadius(cornerTopRightRadius: Int) {
        this.cornerTopRightRadius = context.dp2px(cornerTopRightRadius)
        calculateRadiiAndRectF(true)
    }

    fun setCornerBottomLeftRadius(cornerBottomLeftRadius: Int) {
        this.cornerBottomLeftRadius = context.dp2px(cornerBottomLeftRadius)
        calculateRadiiAndRectF(true)
    }

    fun setCornerBottomRightRadius(cornerBottomRightRadius: Int) {
        this.cornerBottomRightRadius = context.dp2px(cornerBottomRightRadius)
        calculateRadiiAndRectF(true)
    }
